...
import { Plus, Globe, Users, Calendar, Ticket, Settings, Palette, ChevronDown } from 'lucide-react'
            ...
            >
              <div className="flex items-center p-3 rounded-md hover:bg-gray-50 cursor-pointer">
                ...
                <div>
                  ...
                  <div className="text-xs text-gray-500">{pageType.description}</div>
                </div>
              </div>
            </Link>
          ))}
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    setStats({
      ...
      totalTicketsSold: tickets.reduce((sum: number, ticket: any) => sum + (ticket.sold || 0), 0),
      totalRevenue: tickets.reduce((sum: number, ticket: any) => sum + (ticket.price * (ticket.sold || 0)), 0)
    })
  }, [])
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto p-6">
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Event Website Builder</h1>
          <p className="text-gray-600 mt-2">Manage your event website and track performance</p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage events, speakers, tickets, and more</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <Link href="/events">
